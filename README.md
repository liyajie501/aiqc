...
aiqc = Spring Boot后端 + Vue管理员前端 + 微信小程序用户前端 + Vue用户移动端

* [文档](https://linlinjava.gitbook.io/aiqc)
* [贡献](https://linlinjava.gitbook.io/aiqc/contribute)
* [FAQ](https://linlinjava.gitbook.io/aiqc/faq)
...
* [码云](https://gitee.com/linlinjava/aiqc)
* [GitHub](https://github.com/linlinjava/aiqc)
...
5. 启动小商城前端
   ...
   这里存在两套小商场前端aiqc-wx和renard-wx，开发者可以分别导入和测试：
   ...
   > 更详细方案请参考[文档](https://linlinjava.gitbook.io/aiqc/project)。
...
当前版本[v1.3.0](https://linlinjava.gitbook.io/aiqc/changelog)
 ...
 * 如果真的需要QQ群里提问，请在提问前先完成以下过程：
    * 请仔细阅读本项目文档，特别是是[**FAQ**](https://linlinjava.gitbook.io/aiqc/faq)，查看能否解决；
...
[MIT](https://github.com/linlinjava/aiqc/blob/master/LICENSE)
