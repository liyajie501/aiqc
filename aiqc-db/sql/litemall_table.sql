...
--
-- Table structure for table `aiqc_ad`
--

DROP TABLE IF EXISTS `aiqc_ad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_ad` (
...
--
-- Table structure for table `aiqc_address`
--

DROP TABLE IF EXISTS `aiqc_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_admin`
--

DROP TABLE IF EXISTS `aiqc_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_brand`
--

DROP TABLE IF EXISTS `aiqc_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_brand` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_cart`
--

DROP TABLE IF EXISTS `aiqc_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_category`
--

DROP TABLE IF EXISTS `aiqc_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_collect`
--

DROP TABLE IF EXISTS `aiqc_collect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `aiqc_comment`
--

DROP TABLE IF EXISTS `aiqc_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_coupon`
--

DROP TABLE IF EXISTS `aiqc_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_coupon_user`
--

DROP TABLE IF EXISTS `aiqc_coupon_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_feedback`
--

DROP TABLE IF EXISTS `aiqc_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `aiqc_footprint`
--

DROP TABLE IF EXISTS `aiqc_footprint`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_footprint` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户表的用户ID',
...
--
-- Table structure for table `aiqc_goods`
--

DROP TABLE IF EXISTS `aiqc_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_goods_attribute`
--

DROP TABLE IF EXISTS `aiqc_goods_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_goods_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_goods_product`
--

DROP TABLE IF EXISTS `aiqc_goods_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_goods_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `aiqc_goods_specification`
--

DROP TABLE IF EXISTS `aiqc_goods_specification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_goods_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品表的商品ID',
...
--
-- Table structure for table `aiqc_groupon`
--

DROP TABLE IF EXISTS `aiqc_groupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_groupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL COMMENT '关联的订单ID',
  `groupon_id` int(11) DEFAULT '0' COMMENT '参与的团购ID，仅当user_type不是1',
  `rules_id` int(11) NOT NULL COMMENT '团购规则ID，关联aiqc_groupon_rules表ID字段',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Table structure for table `aiqc_groupon_rules`
--

DROP TABLE IF EXISTS `aiqc_groupon_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_groupon_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_issue`
--

DROP TABLE IF EXISTS `aiqc_issue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_issue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_keyword`
--

DROP TABLE IF EXISTS `aiqc_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_log`
--

DROP TABLE IF EXISTS `aiqc_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_order`
--

DROP TABLE IF EXISTS `aiqc_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_order_goods`
--

DROP TABLE IF EXISTS `aiqc_order_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_order_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_permission`
--

DROP TABLE IF EXISTS `aiqc_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_permission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_region`
--

DROP TABLE IF EXISTS `aiqc_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_region` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_role`
--

DROP TABLE IF EXISTS `aiqc_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_search_history`
--

DROP TABLE IF EXISTS `aiqc_search_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_search_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户表的用户ID',
...
--
-- Table structure for table `aiqc_storage`
--

DROP TABLE IF EXISTS `aiqc_storage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_storage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_system`
--

DROP TABLE IF EXISTS `aiqc_system`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_topic`
--

DROP TABLE IF EXISTS `aiqc_topic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_user`
--

DROP TABLE IF EXISTS `aiqc_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `aiqc_user_formid`
--

DROP TABLE IF EXISTS `aiqc_user_formid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aiqc_user_formid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
