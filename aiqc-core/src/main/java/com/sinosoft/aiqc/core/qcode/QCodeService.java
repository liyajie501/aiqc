package com.sinosoft.aiqc.core.qcode;

import cn.binarywang.wx.miniapp.api.WxMaService;
import me.chanjar.weixin.common.error.WxErrorException;
import com.sinosoft.aiqc.core.storage.StorageService;
import com.sinosoft.aiqc.core.system.SystemConfig;
//import com.sinosoft.aiqc.db.domain.aiqcGroupon;
//import com.sinosoft.aiqc.db.domain.aiqcStorage;
...
//    public String createGrouponShareImage(String goodName, String goodPicUrl, aiqcGroupon groupon) {
//        try {
//            //创建该商品的二维码
...
//            //存储分享图
//            aiqcStorage storageInfo = storageService.store(inputStream2, imageData.length, "image/jpeg", getKeyName(groupon.getId().toString()));
//
...
//            ByteArrayInputStream inputStream2 = new ByteArrayInputStream(imageData);
//            //存储分享图
//            aiqcStorage aiqcStorage = storageService.store(inputStream2, imageData.length, "image/jpeg", getKeyName(goodId));
//
//            return aiqcStorage.getUrl();
//        } catch (WxErrorException e) {
//            e.printStackTrace();
//        } catch (FileNotFoundException e) {
//            e.printStackTrace();
