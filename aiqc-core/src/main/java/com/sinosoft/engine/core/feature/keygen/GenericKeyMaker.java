package com.sinosoft.engine.core.feature.keygen;
...
public class GenericKeyMaker {
    ...
    private String getLicenseId() {
        return String.format("D%sT", new Object[]{Integer.toString(this.random.nextInt(90000) + 10000)});
    }
    ...
    private byte[] generateKeyBytes(int licenseType, int productId, int minorVersion, int majorVersion, String userName, int customerId) {
        ...
        keyBytes[2] = (byte) (int) (time & 0xFFL);
        keyBytes[3] = (byte) (int) (time >> 8 & 0xFFL);
        keyBytes[4] = (byte) (int) (time >> 16 & 0xFFL);
        keyBytes[5] = (byte) (int) (time >> 24 & 0xFFL);
        long timeDiff = 36135L;

        timeDiff &= 0xFFFFL;
        keyBytes[6] = (byte) (int) (timeDiff & 0xFFL);
        keyBytes[7] = (byte) (int) (timeDiff >> 8 & 0xFFL);
        keyBytes[8] = 0;
        keyBytes[9] = 1;
        keyBytes[10] = 2;
        keyBytes[11] = 3;
    ...
    public String generateKey(BigInteger privKey, BigInteger pubKey, int licenseType, int productId, int minorVersion, int majorVersion, String userName) {
        int customerId = this.random.nextInt(9000) + 1000;
    ...
    public String genericPyCharmKey(int minorVersion, int majorVersion, String userName) {
        ...
        return generateKey(privKey, pubKey, 1, 5, minorVersion, majorVersion, userName);
    }
    ...
    public String genericAppCodeKey(int minorVersion, int majorVersion, String userName) {
        ...
        return generateKey(privKey, pubKey, 1, 8, minorVersion, majorVersion, userName);
    }
    ...
    public String genericPhpStormKey(int minorVersion, int majorVersion, String userName) {
        ...
        return generateKey(privKey, pubKey, 1, 7, minorVersion, majorVersion, userName);
    }
    ...
    public String genericRubyMineKey(int minorVersion, int majorVersion, String userName) {
        ...
        return generateKey(privKey, pubKey, 1, 4, minorVersion, majorVersion, userName);
    }
    ...
    public String genericWebStormKey(int minorVersion, int majorVersion, String userName) {
        ...
        return generateKey(privKey, pubKey, 1, 6, minorVersion, majorVersion, userName);
    }
